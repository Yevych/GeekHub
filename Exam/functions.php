...
function theme_setup() {
	...
	register_nav_menus( array(
        ...
        'secondary-menu' => esc_html__( 'Secondary menu', 'theme' ),
        'industry-menu' => esc_html__( 'Industry menu', 'theme' ),
        'social-menu' => esc_html__( 'Social menu', 'theme' ),
	) );
...
function theme_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar category', 'theme' ),
        'id'            => 'sidebar-2',
        'description'   => esc_html__( 'Add widgets here.', 'theme' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
...
function theme_scripts() {
    ...
    //All fonts
    wp_enqueue_style('fonts', 'https://fonts.googleapis.com/css?family=Domine|Lato:300|Montserrat:400,700" rel="stylesheet');
